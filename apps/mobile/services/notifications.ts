...
/** Lazy-load expo-notifications — returns null if native module is missing */
...
/** Lazy-load expo-device — returns null if native module is missing */
...
/**
 * Full registration flow: setup channels → request permission → save token.
